  ...
  return (
    <div>
      ...
      <p className="text-clay text-[13px] mt-0.5 mb-5">
        {realUploads.length + sampleTemplates.length} downloadable activities — choose from memory boxes,
        conversation prompts, photo collections, and more
      </p>

      {realUploads.length > 0 && (
        <>
          <p className="text-xs font-semibold text-sageDeep mb-2 uppercase tracking-wide">
            From your library
          </p>
              ...
              >
                ...
                <div className="flex gap-2 shrink-0">
                  ...
                  {t.answerFileUrl && (
                      ...
                      href={t.answerFileUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold"
                      style={{ background: "#E1E6ED", color: "#3E5876" }}
                    >
                      Download Answers
                    </a>
                  )}
                  {t.videoUrl && (
                      ...
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold"
                      style={{ background: "#F3DAD8", color: "#B5453D" }}
                    >
                      Watch on YouTube
                    </a>
                  )}
      ...
      {sampleTemplates.length > 0 && (
        <>
          {realUploads.length > 0 && (
            <p className="text-xs font-semibold text-inkSoft mb-2 uppercase tracking-wide">
              Sample activities
            </p>
          )}
